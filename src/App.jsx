  ...
  return (
    <div className="app-shell">
      ...
      <aside className="story-rail" aria-label="Page story progress">
        <a className={activeSection === "top" ? "active" : ""} href="#top" aria-label="Return to introduction">00</a>
        <a className={activeSection === "platform" ? "active" : ""} href="#platform" aria-label="Go to AI platform">01</a>
        <a className={activeSection === "diligence" ? "active" : ""} href="#diligence" aria-label="Go to acquisition readiness">02</a>
        <a className={activeSection === "transaction-faq" ? "active" : ""} href="#transaction-faq" aria-label="Go to buyer FAQ">03</a>
        <a className={activeSection === "acquire" ? "active" : ""} href="#acquire" aria-label="Go to acquisition contact">04</a>
      </aside>
      ...
      <header className={`site-header ${headerCompact ? "is-compact" : ""}`}>
        ...
        >
          ...
          <a className={activeSection === "diligence" ? "active" : ""} href="#diligence" onClick={() => setMobileMenuOpen(false)}>Acquisition</a>
          <a className={activeSection === "transaction-faq" ? "active" : ""} href="#transaction-faq" onClick={() => setMobileMenuOpen(false)}>FAQ</a>
          <a href="/enterprise.html" onClick={() => setMobileMenuOpen(false)}>Enterprise</a>
          <button
